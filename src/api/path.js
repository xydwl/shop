...
// 获取手机验证码
Auth.phoneNum = {url: '/api/login/getVerificationCode.htm', method: 'post'}
// 图片图形验证码
Auth.ValidateImgUrl = {url: '/api/login/getValidateImgCode.htm', method: 'post'}
// 图片验证码上的验证码
Auth.getcaptchas = {url: '/api/login/getVerificationCodeTemp.htm', method: 'post'}
// 注册
Auth.resginUser = {url: '/api/login/userRegister.htm', method: 'post'}
// 忘记重置密码
Auth.resetPsd = {url: '/api/login/resetPassword.htm', method: 'post'}
// 修改手机号
Auth.updateMobileUrl = {url: '/api/login/updateMobile.htm', method: 'post'}
// 重置密码
Auth.resetPsd = {url: '/api/login/resetPassword.htm', method: 'post'}

// 关键词
PecooIndex.KeywordsUrl = {url: '/api/indexPage/queryHotKeywords.htm', method: 'get'}
// 三级菜单
PecooIndex.Subwords = {url: '/api/indexPage/getSubKinds.htm', method: 'get'}
// banner
PecooIndex.queryBanner = {url: '/api/indexPage/queryBanner.htm', method: 'post'}
// 首页今日推荐部分
PecooIndex.queryQualityGoodsUrl = {url: '/api/indexPage/queryQualityGoods.htm', method: 'post'}
// 首页拍卖会部分
PecooIndex.queryQualityAuctionUrl = {url: '/api/indexPage/queryQualityAuction.htm', method: 'get'}
// 首页奢侈品部分
PecooIndex.queryQualityFlashGoodsUrl = {url: '/api/indexPage/queryQualityGoods.htm', method: 'post'}
// 搜索列表页
PecooIndex.queryIndexPageGoodsUrl = {url: '/api/indexPage/queryIndexPageGoods.htm', method: 'post'}
// 猜你喜欢接口
PecooIndex.queryPopularGoods = {url: '/api/indexPage/queryPopularGoods.htm', method: 'get'}
// 根据关键词查询分页显示
PecooIndex.searchKeywordsUrl = {url: '/api/indexPage/searchKeywords.htm', method: 'get'}
// 全球拍卖会
...
// 添加收货地址
userCenter.getAddressUrl = {url: '/api/verify/address/addAddress.htm', method: 'get'}
// 查询默认收货地址
userCenter.queryDefaultAddress = {url: '/api/verify/address/queryDefaultAddress.htm', method: 'get'}
// 编辑收货地址
userCenter.updateAddressUrl = {url: '/api/verify/address/updateAddress.htm', method: 'get'}
// 删除收货地址
userCenter.deleteAddress = {url: '/api/verify/address/deleteAddress.htm', method: 'get'}
// 用户详情
userCenter.queryMyPecoo = {url: '/api/verify/account/queryMyPecoo.htm', method: 'post'}
// 我的拍品
userCenter.queryAllBidGoodsUrl = {url: '/api/verify/order/queryAllBidGoods.htm', method: 'get'}
// 已出价
userCenter.queryHaveBidGoodsUrl = {url: '/api/verify/order/queryHaveBidGoods.htm', method: 'get'}
// 竞拍成功
userCenter.querySuccBidGoodsUrl = {url: '/api/verify/order/querySuccBidGoods.htm', method: 'get'}
// 已付款
userCenter.queryPaidBidGoodsUrl = {url: '/api/verify/order/queryPaidBidGoods.htm', method: 'get'}
// 已发货
userCenter.queryDeliverBidGoodsUrl = {url: '/api/verify/order/queryDeliverBidGoods.htm', method: 'get'}
// 已完成
userCenter.queryCompleteBidGoodsUrl = {url: '/api/verify/order/queryCompleteBidGoods.htm', method: 'get'}
// 竞拍失败
userCenter.queryFailedBidGoodsUrl = {url: '/api/verify/order/queryFailedBidGoods.htm', method: 'get'}
// 取消订单
userCenter.cancelBidOrderUrl = {url: '/api/verify/order/cancelBidOrder.htm', method: 'get'}
// 确认收货
